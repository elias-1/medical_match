...
def get_disease_symptom(posDis, yes_sids, not_sids,
    ...
    with open(
            '/var/www/djangoapi/file/symptom_disease/disease-symptomlist-dict.json',
            'r') as f:
    ...
    with open(
            '/var/www/djangoapi/file/symptom_disease/symptom-id-name-dict.json',
            'r') as f:
...
def get_dis_list(didlist, prefix=''):
    ...
    did_name_dict = myreadjson(
        '/var/www/djangoapi/file/symptom_disease/disease-id-name-dict.json')
    dep_name_dict = myreadjson(
        '/var/www/djangoapi/file/symptom_disease/department-id-name-dict.json')
    did_deplist_dict = myreadjson(
        '/var/www/djangoapi/file/symptom_disease/disease-departmentlist-dict.json'
    )
    did_list_new = []
    for did in didlist:
        d = {}
