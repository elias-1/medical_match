...
_RESOURCEHANDLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='device',
            full_name='tensorflow.ResourceHandle.device',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='container',
            full_name='tensorflow.ResourceHandle.container',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='name',
            full_name='tensorflow.ResourceHandle.name',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='hash_code',
            full_name='tensorflow.ResourceHandle.hash_code',
            index=3,
            number=4,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='tensorflow.ResourceHandle.maybe_type_name',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
ResourceHandle = _reflection.GeneratedProtocolMessageType(
    'ResourceHandle',
    (_message.Message, ),
    dict(
